...
import AbstractMapLoader = require('AbstractMapLoader');
import ResourceLoader = require('../util/ResourceLoader');
import MapLayer = require('MapLayer');
import TileSet = require('TileSet');
import TileLayer = require('TileLayer');
import ObjectLayer = require('ObjectLayer');
import TiledMap = require('TiledMap');
