...
module SpaceshipInTrouble.Engine.EntitySystem {
    ...
    export class EntityMessage {
         ...
         */
        private _sender: SpaceshipInTrouble.Engine.EntitySystem.Entity;
         ...
         */
        constructor(identifier:string = "undefined", message:any = {}, sender: SpaceshipInTrouble.Engine.EntitySystem.Entity = null, isConsumable:boolean = true) {
