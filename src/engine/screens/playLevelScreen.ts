...
import AbstractScreen = require('AbstractScreen');
import VirtualJoystick = require('../Helper/VirtualJoystick');
import KeyboardHelper = require('../Helper/KeyboardHelper');
import EntityManager = require('../Entity/EntityManager');
import EntityMessage = require('../Entity/EntityMessage');
import MapLayer = require('../map/MapLayer');
import TileSet = require('../map/TileSet');
